...
export default definePreset((options) => {
	...
	return {
		...
		rules: [
			...
			[/^mw-([\.\d]+)(!)?$/, ([_, value, important]) => ({ 'max-width': `${value === 'inherit' ? `inherit ${important ? '!important' : ''}` : value === 'auto' ? `auto ${important ? '!important' : ''}` : `${value}rem ${important ? '!important' : ''}`}` })],
			[/^mh-([\.\d]+)(!)?$/, ([_, value, important]) => ({ 'max-height': `${value === 'inherit' ? `inherit ${important ? '!important' : ''}` : value === 'auto' ? `auto ${important ? '!important' : ''}` : `${value}rem ${important ? '!important' : ''}`}` })],
